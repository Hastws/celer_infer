...
namespace celer_infer {
    ...
    inline int64_t numel_3d(int64_t a2, int64_t a1, int64_t a0) { return a2 * a1 * a0; }
    inline int64_t numel_4d(int64_t a3, int64_t a2, int64_t a1, int64_t a0) { return a3 * a2 * a1 * a0; }

    inline int64_t numel_5d(int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0) {
        return a4 * a3 * a2 * a1 * a0;
    }

    inline int64_t off_2d(int64_t i1, int64_t i0, int64_t a0) { return i1 * a0 + i0; }

    inline int64_t off_3d(int64_t i2, int64_t i1, int64_t i0, int64_t a1, int64_t a0) {
        return (i2 * a1 + i1) * a0 + i0;
    }

    inline int64_t off_4d(int64_t i3, int64_t i2, int64_t i1, int64_t i0, int64_t a2, int64_t a1, int64_t a0) {
        return ((i3 * a2 + i2) * a1 + i1) * a0 + i0;
    }

    inline int64_t off_5d(int64_t i4,
                          int64_t i3,
                          int64_t i2,
                          int64_t i1,
                          int64_t i0,
    ...
    inline void fill(float *out, int64_t o1, int64_t o0, float v) { fill(out, o1 * o0, v); }
    inline void fill(float *out, int64_t o2, int64_t o1, int64_t o0, float v) { fill(out, o2 * o1 * o0, v); }

    inline void fill(float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0, float v) {
        fill(out, o3 * o2 * o1 * o0, v);
    }

    inline void fill(float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0, float v) {
    ...
    inline void copy(const float *a, int64_t a1, int64_t a0, float *out, int64_t o1, int64_t o0) {
        assert(a1 == o1 && a0 == o0);
        copy(a, a1 * a0, out, o1 * o0);
    }

    inline void copy(const float *a, int64_t a2, int64_t a1, int64_t a0,
    ...
    inline void copy(const float *a, int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                     float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void add(const float *a, int64_t n, const float *b, int64_t nb, float *out, int64_t no) {
        assert(n == nb && n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] + b[i];
    }

    inline void sub(const float *a, int64_t n, const float *b, int64_t nb, float *out, int64_t no) {
        assert(n == nb && n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] - b[i];
    }

    inline void mul(const float *a, int64_t n, const float *b, int64_t nb, float *out, int64_t no) {
        assert(n == nb && n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] * b[i];
    }

    inline void div(const float *a, int64_t n, const float *b, int64_t nb, float *out, int64_t no) {
        assert(n == nb && n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] / b[i];
    }
    ...
    inline void add(const float *a, int64_t a1, int64_t a0,
    ...
    inline void add(const float *a, int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                    const float *b, int64_t b4, int64_t b3, int64_t b2, int64_t b1, int64_t b0,
                    float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        assert(a4 == b4 && a3 == b3 && a2 == b2 && a1 == b1 && a0 == b0);
        assert(a4 == o4 && a3 == o3 && a2 == o2 && a1 == o1 && a0 == o0);
        add(a, a4 * a3 * a2 * a1 * a0, b, b4 * b3 * b2 * b1 * b0, out, o4 * o3 * o2 * o1 * o0);
    }
    ...
    inline void add_scalar(const float *a, int64_t n, float s, float *out, int64_t no) {
        assert(n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] + s;
    }

    inline void mul_scalar(const float *a, int64_t n, float s, float *out, int64_t no) {
        assert(n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] * s;
    }

    inline void clamp(const float *a, int64_t n, float lo, float hi, float *out, int64_t no) {
        assert(n == no);
    ...
    inline void swiglu(const float *gate, int64_t n, const float *up, int64_t nu, float *out, int64_t no) {
        assert(n == nu && n == no);
        for (int64_t i = 0; i < n; ++i) {
    ...
    inline void add_lastdim_vec(const float *x, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                                const float *w, int64_t w0,
                                float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void add_lastdim_vec(const float *x, int64_t x4, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                                const float *w, int64_t w0,
                                float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void sum_lastdim(const float *x, int64_t outer, int64_t a0, float *out, int64_t o0) {
        assert(outer == o0);
        for (int64_t i = 0; i < outer; ++i) {
    ...
    inline void mean_lastdim(const float *x, int64_t outer, int64_t a0, float *out, int64_t o0) {
        sum_lastdim(x, outer, a0, out, o0);
        const float inv = 1.0f / static_cast<float>(a0);
        for (int64_t i = 0; i < o0; ++i) out[i] *= inv;
    }

    inline void max_lastdim(const float *x, int64_t outer, int64_t a0, float *out, int64_t o0) {
        assert(outer == o0);
        for (int64_t i = 0; i < outer; ++i) {
            const float *row = x + i * a0;
            float mx = row[0];
    ...
    inline void reduce_sum_5d_axis(const float *x,
                                   int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                                   int32_t axis_neg,
                                   float *out,
                                   int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
                ...
                for (int64_t i2 = 0; i2 < a2; ++i2) {
                    for (int64_t i1 = 0; i1 < a1; ++i1) {
                        for (int64_t i0 = 0; i0 < a0; ++i0) {
                            ...
                            // Output is 4D packed as (o4,o3,o2,o1,o0) but only first 4 are meaningful.
                            // We interpret output as contiguous with dims exactly as provided.
    ...
    inline void softmax_lastdim(const float *x, int64_t outer, int64_t a0, float *out) {
        for (int64_t i = 0; i < outer; ++i) {
            const float *row = x + i * a0;
            float *orow = out + i * a0;
    ...
    inline void log_softmax_lastdim(const float *x, int64_t outer, int64_t a0, float *out) {
        for (int64_t i = 0; i < outer; ++i) {
            const float *row = x + i * a0;
            float *orow = out + i * a0;
            ...
            double sum = 0.0;
            for (int64_t j = 0; j < a0; ++j) sum += static_cast<double>(std::exp(row[j] - mx));
            const float logsum = (sum > 0.0) ? static_cast<float>(std::log(sum)) : neg_inf_f32();
            for (int64_t j = 0; j < a0; ++j) orow[j] = (row[j] - mx) - logsum;
        }
    }

    // Wrappers (2D~5D)
    inline void softmax(const float *x, int64_t x1, int64_t x0, float *out, int64_t o1, int64_t o0) {
        assert(x1 == o1 && x0 == o0);
    ...
    inline void softmax(const float *x, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                        float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        assert(x3 == o3 && x2 == o2 && x1 == o1 && x0 == o0);
        softmax_lastdim(x, x3 * x2 * x1, x0, out);
    }

    inline void softmax(const float *x, int64_t x4, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                        float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        assert(x4 == o4 && x3 == o3 && x2 == o2 && x1 == o1 && x0 == o0);
        softmax_lastdim(x, x4 * x3 * x2 * x1, x0, out);
    }

    inline void log_softmax(const float *x, int64_t x1, int64_t x0, float *out, int64_t o1, int64_t o0) {
        assert(x1 == o1 && x0 == o0);
    ...
    inline void matmul_nn(const float *a, int64_t a1, int64_t a0,
                          const float *b, int64_t b1, int64_t b0,
                          float *out, int64_t o1, int64_t o0) {
        assert(a0 == b1);
        assert(o1 == a1 && o0 == b0);
        ...
        for (int64_t i = 0; i < m; ++i) {
            ...
            for (int64_t j = 0; j < n; ++j) {
                double acc = 0.0;
                for (int64_t t = 0; t < k; ++t) acc += static_cast<double>(ai[t]) * static_cast<double>(b[t * n + j]);
    ...
    inline void matmul_nt(const float *a, int64_t a1, int64_t a0,
                          const float *b, int64_t b1, int64_t b0,
                          float *out, int64_t o1, int64_t o0) {
        assert(a0 == b0);
        assert(o1 == a1 && o0 == b1);
        ...
        for (int64_t i = 0; i < m; ++i) {
            ...
            for (int64_t j = 0; j < n; ++j) {
                ...
                double acc = 0.0;
                for (int64_t t = 0; t < k; ++t) acc += static_cast<double>(ai[t]) * static_cast<double>(bj[t]);
                oi[j] = static_cast<float>(acc);
            }
        }
    }
    ...
    inline void matmul_nn(const float *a, int64_t a2, int64_t a1, int64_t a0,
        ...
        for (int64_t bi = 0; bi < batch; ++bi) {
            matmul_nn(a + bi * a_stride, m, k, b + bi * b_stride, k, n, out + bi * o_stride, m, n);
        }
    }

    // 4D: A(a3,a2,a1,a0), B(b3,b2,b1,b0) -> batch = a3*a2, mat dims = (a1,a0)
    inline void matmul_nn(const float *a, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                          const float *b, int64_t b3, int64_t b2, int64_t b1, int64_t b0,
                          float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        assert(a3 == b3 && a2 == b2);
        assert(a0 == b1);
    ...
    inline void matmul_nn(const float *a, int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                          const float *b, int64_t b4, int64_t b3, int64_t b2, int64_t b1, int64_t b0,
                          float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    // Linear (no bias): x(..., in) @ w(out, in)^T  where w dims are (out,in): w1=out,w0=in
    // This matches PyTorch nn.Linear without bias and weight layout [out_features, in_features].
    inline void linear_no_bias(const float *x, int64_t x2, int64_t x1, int64_t x0,
                               const float *w, int64_t w1, int64_t w0,
                               float *out, int64_t o2, int64_t o1, int64_t o0) {
        assert(x2 == o2 && x1 == o1);
        assert(w0 == x0);
        assert(o0 == w1);
    ...
    inline void transpose_2d(const float *a, int64_t a1, int64_t a0, float *out, int64_t o1, int64_t o0) {
        assert(o1 == a0 && o0 == a1);
        for (int64_t i1 = 0; i1 < a1; ++i1) {
            for (int64_t i0 = 0; i0 < a0; ++i0) {
    ...
    inline void permute_5d(const float *x,
                           int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                           const int32_t *perm5,
                           float *out,
                           int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void slice_5d(const float *x,
                         int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                         int64_t s4, int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                         int64_t n4, int64_t n3, int64_t n2, int64_t n1, int64_t n0,
                         float *out,
                         int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
            ...
            for (int64_t i3 = 0; i3 < n3; ++i3) {
                for (int64_t i2 = 0; i2 < n2; ++i2) {
                    for (int64_t i1 = 0; i1 < n1; ++i1) {
                        const float *src = x + off_5d(s4 + i4, s3 + i3, s2 + i2, s1 + i1, s0, a3, a2, a1, a0);
    ...
    inline void pad_5d_constant(const float *x,
                                int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                                int64_t p4l, int64_t p4r,
                                int64_t p3l, int64_t p3r,
                                int64_t p2l, int64_t p2r,
                                int64_t p1l, int64_t p1r,
                                int64_t p0l, int64_t p0r,
                                float val,
                                float *out,
                                int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
            ...
            for (int64_t i3 = 0; i3 < a3; ++i3) {
                for (int64_t i2 = 0; i2 < a2; ++i2) {
                    for (int64_t i1 = 0; i1 < a1; ++i1) {
                        ...
                        float *dst = out + off_5d(i4 + p4l, i3 + p3l, i2 + p2l, i1 + p1l, p0l, o3, o2, o1, o0);
    ...
    inline void concat_5d_axis(const float *a,
                               int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                               const float *b,
                               int64_t b4, int64_t b3, int64_t b2, int64_t b1, int64_t b0,
                               int32_t axis_neg,
                               float *out,
                               int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        assert(axis_neg <= -1 && axis_neg >= -5);
        ...
        for (int64_t p = 0; p < pre; ++p) {
            ...
            std::memcpy(out + o_off_a, a + a_off, static_cast<size_t>(a_axis * post) * sizeof(float));

            const int64_t b_off = p * (b_axis * post);
            const int64_t o_off_b = o_off_a + a_axis * post;
            std::memcpy(out + o_off_b, b + b_off, static_cast<size_t>(b_axis * post) * sizeof(float));
        }
    }
    ...
    // ids(a1,a0) int32 -> out(a1,a0,emb_dim) where out is (o2,o1,o0) = (a1,a0,emb_dim)
    inline void embedding(const int32_t *ids, int64_t id1, int64_t id0,
                          const float *emb, int64_t e1, int64_t e0,
                          float *out, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void one_hot(const int32_t *ids, int64_t n, int32_t num_classes, float on, float off,
                        float *out, int64_t o1, int64_t o0) {
    ...
    inline void layer_norm_lastdim(const float *x, int64_t outer, int64_t a0,
        ...
        for (int64_t i = 0; i < outer; ++i) {
            ...
            float *orow = out + i * a0;
            for (int64_t j = 0; j < a0; ++j) {
                const float xn = static_cast<float>((static_cast<double>(row[j]) - mean)) * inv;
    ...
    inline void apply_rotary_pos_emb_4d_inplace(float *q, int64_t q3, int64_t q2, int64_t q1, int64_t q0,
                                                float *k, int64_t k3, int64_t k2, int64_t k1, int64_t k0,
                                                const float *cos, int64_t c1, int64_t c0,
                                                const float *sin, int64_t s1, int64_t s0) {
    ...
    inline void apply_rotary_pos_emb_5d_inplace(float *q,
                                                int64_t q4, int64_t q3, int64_t q2, int64_t q1, int64_t q0,
                                                float *k,
                                                int64_t k4, int64_t k3, int64_t k2, int64_t k1, int64_t k0,
                                                const float *cos, int64_t c1, int64_t c0,
                                                const float *sin, int64_t s1, int64_t s0) {
    ...
    inline void repeat_kv_4d(const float *x, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                             int64_t n_rep,
                             float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void concat_seq_4d(const float *past, int64_t p3, int64_t p2, int64_t p1, int64_t p0,
                              const float *cur, int64_t c3, int64_t c2, int64_t c1, int64_t c0,
                              float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void apply_causal_mask_last_block(float *scores,
                                             int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                                             int64_t cur_len) {
    ...
    inline void add_attention_mask(float *scores,
                                   int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                                   const uint8_t *mask, int64_t m1, int64_t m0,
                                   float neg = -1e9f) {
        assert(m1 == s3 && m0 == s0);
        const int64_t B = s3, H = s2, M = s1, N = s0;
    ...
    // ============================================================================
    // MoE / routing primitives (topk / normalize / bincount / argsort / gather / scatter_add)
    // ============================================================================

    // x: (rows, cols) => dims (x1,x0). TopK over last dim x0.
    inline void topk_lastdim_2d(const float *x, int64_t x1, int64_t x0,
                                int32_t k,
        ...
        for (int64_t r = 0; r < x1; ++r) {
            ...
            for (int32_t c = 0; c < static_cast<int32_t>(x0); ++c) {
                const float v = row[c];
                int32_t worst = 0;
                for (int32_t t = 1; t < k; ++t) if (vrow[t] < vrow[worst]) worst = t;
                if (v > vrow[worst]) {
                    vrow[worst] = v;
                    irow[worst] = c;
                }
    ...
    inline void normalize_topk_prob_2d_inplace(float *w, int64_t w1, int64_t w0, float eps = 1e-20f) {
    ...
    inline void bincount_i32(const int32_t *x, int64_t n, int32_t num_bins, int64_t *out_counts, int64_t c0) {
        assert(c0 == num_bins);
    ...
    inline void gather_rows_2d(const float *x, int64_t x1, int64_t x0,
        ...
        for (int64_t i = 0; i < n; ++i) {
            ...
            assert(0 <= r && r < x1);
            std::memcpy(out + i * o0, x + r * x0, static_cast<size_t>(x0) * sizeof(float));
        }
    }
    ...
    inline void where_1d(const uint8_t *cond, int64_t n,
    ...
    inline void masked_fill_1d(const float *x, int64_t n,
                               const uint8_t *mask, int64_t nm,
                               float val,
                               float *out, int64_t no) {
        assert(n == nm && n == no);
    ...
    inline void quantize_per_tensor_f32_to_i8(const float *x, int64_t n, float scale, int32_t zero_point,
    ...
    inline void dequantize_per_tensor_i8_to_f32(const int8_t *x, int64_t n, float scale, int32_t zero_point,
                                                float *out, int64_t no) {
        assert(n == no);
        for (int64_t i = 0; i < n; ++i) {
    ...
    inline void transpose_bshd_to_bhsd(const float *x,
                                       int64_t x3, int64_t x2, int64_t x1, int64_t x0, // (B,S,H,D)
                                       float *out,
    ...
    inline void transpose_bhsd_to_bshd(const float *x,
                                       int64_t x3, int64_t x2, int64_t x1, int64_t x0, // (B,H,S,D)
                                       float *out,
                                       int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        // (B,S,H,D)
        assert(o3 == x3 && o2 == x1 && o1 == x2 && o0 == x0);
    ...
    inline void transpose_bst_to_bts(const float *x, int64_t x2, int64_t x1, int64_t x0, // (B,S,T)
                                     float *out, int64_t o2, int64_t o1, int64_t o0) {
        // (B,T,S)
    ...
    inline void attn_qk_matmul(const float *q, int64_t q3, int64_t q2, int64_t q1, int64_t q0,
                               const float *k, int64_t k3, int64_t k2, int64_t k1, int64_t k0,
                               float scale,
                               float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
            ...
            for (int64_t h = 0; h < H; ++h) {
                for (int64_t s = 0; s < S; ++s) {
                    ...
                    for (int64_t t = 0; t < T; ++t) {
                        ...
                        double acc = 0.0;
                        for (int64_t d = 0; d < D; ++d) acc += static_cast<double>(qv[d]) * static_cast<double>(kv[d]);
    ...
    inline void attn_pv_matmul(const float *probs, int64_t p3, int64_t p2, int64_t p1, int64_t p0,
                               const float *v, int64_t v3, int64_t v2, int64_t v1, int64_t v0,
                               float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void attn_softmax_scores(const float *scores, int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                                    float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void cross_entropy_logits_2d_mean(const float *logits, int64_t l1, int64_t l0,
                                             const int32_t *target, int64_t t0,
        ...
        for (int64_t i = 0; i < l1; ++i) {
            ...
            double sum = 0.0;
            for (int64_t c = 0; c < l0; ++c) sum += static_cast<double>(std::exp(row[c] - mx));
            const double logsum = (sum > 0.0) ? std::log(sum) : 0.0;

            const double logp = static_cast<double>(row[y] - mx) - logsum; // log-softmax
            loss_sum += -logp;
            ++count;
        }

        out[0] = (count > 0) ? static_cast<float>(loss_sum / static_cast<double>(count)) : 0.0f;
    }

    // out: (1) scalar sum over non-ignored targets
    inline void cross_entropy_logits_2d_sum(const float *logits, int64_t l1, int64_t l0,
                                            const int32_t *target, int64_t t0,
                                            int32_t ignore_index,
                                            float *out, int64_t o0) {
        assert(t0 == l1);
    ...
    inline void cross_entropy_logits_2d_none(const float *logits, int64_t l1, int64_t l0,
                                             const int32_t *target, int64_t t0,
                                             int32_t ignore_index,
                                             float *out, int64_t o0) {
        assert(t0 == l1);
    ...
    inline void nll_loss_log_probs_2d_mean(const float *log_probs, int64_t l1, int64_t l0,
                                           const int32_t *target, int64_t t0,
                                           int32_t ignore_index,
                                           float *out, int64_t o0) {
        assert(t0 == l1);
    ...
    inline void cross_entropy_logits_3d_shifted_mean(const float *logits, int64_t l2, int64_t l1, int64_t l0,
                                                     const int32_t *labels, int64_t y1, int64_t y0,
                                                     int32_t ignore_index,
                                                     float *out, int64_t o0) {
        assert(y1 == l2 && y0 == l1);
        assert(o0 == 1);
        ...
        for (int64_t b = 0; b < B; ++b) {
            for (int64_t s = 0; s < S - 1; ++s) {
                ...
                double sum = 0.0;
                for (int64_t c = 0; c < V; ++c) sum += static_cast<double>(std::exp(row[c] - mx));
                const double logsum = (sum > 0.0) ? std::log(sum) : 0.0;
    ...
    inline const float *view_reshape_2d_to_4d(const float *x,
                                              int64_t x1, int64_t x0,
                                              int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        view_reshape_check_numel(x1 * x0, o3 * o2 * o1 * o0);
        return x;
    }

    inline float *view_reshape_2d_to_4d(float *x,
                                        int64_t x1, int64_t x0,
                                        int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        view_reshape_check_numel(x1 * x0, o3 * o2 * o1 * o0);
        return x;
    ...
    inline const float *view_reshape_3d_to_4d(const float *x,
    ...
    inline float *view_reshape_3d_to_4d(float *x,
                                        int64_t x2, int64_t x1, int64_t x0,
                                        int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        view_reshape_check_numel(x2 * x1 * x0, o3 * o2 * o1 * o0);
        return x;
    ...
    inline const float *view_reshape_3d_to_5d(const float *x,
                                              int64_t x2, int64_t x1, int64_t x0,
                                              int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline float *view_reshape_3d_to_5d(float *x,
                                        int64_t x2, int64_t x1, int64_t x0,
                                        int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        view_reshape_check_numel(x2 * x1 * x0, o4 * o3 * o2 * o1 * o0);
        return x;
    ...
    inline const float *view_reshape_4d_to_3d(const float *x,
    ...
    inline float *view_reshape_4d_to_3d(float *x,
                                        int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                                        int64_t o2, int64_t o1, int64_t o0) {
        view_reshape_check_numel(x3 * x2 * x1 * x0, o2 * o1 * o0);
        return x;
    ...
    inline const float *view_flatten_to_2d_keep_last(const float *x,
                                                     int64_t numel,
                                                     int64_t a0,
                                                     int64_t *out1, int64_t *out0) {
        assert(a0 > 0);
        assert(numel % a0 == 0);
        *out1 = numel / a0;
        *out0 = a0;
    ...
    inline void add_scaled(const float *a, int64_t n,
                           const float *b, int64_t nb,
                           float alpha,
                           float *out, int64_t no) {
        assert(n == nb && n == no);
    ...
    inline void fma3(const float *a, int64_t n,
                     const float *b, int64_t nb,
                     const float *c, int64_t nc,
                     float *out, int64_t no) {
        assert(n == nb && n == nc && n == no);
        for (int64_t i = 0; i < n; ++i) out[i] = a[i] * b[i] + c[i];
    }

    inline void add_inplace(float *a, int64_t n, const float *b, int64_t nb, float alpha) {
        assert(n == nb);
    ...
    inline void dropout(const float *x, int64_t n,
                        float p,
                        xorshift64s_state *rng,
                        float *out, int64_t no,
                        uint8_t *mask_opt = nullptr, int64_t m0 = 0) {
        assert(n == no);
        ...
        for (int64_t i = 0; i < n; ++i) {
            ...
            const uint8_t m = (u < keep) ? static_cast<uint8_t>(1) : static_cast<uint8_t>(0);
    ...
    inline void linear(const float *x, int64_t x1, int64_t x0,
                       const float *w, int64_t w1, int64_t w0,
                       const float *b, int64_t b0,
                       float *out, int64_t o1, int64_t o0) {
        assert(x1 == o1);
    ...
    //   - cache: keys length = prefix_offset + S, so T == prefix_offset+S, prefix_offset = past_len
    inline void apply_causal_mask(float *scores,
                                  int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                                  int64_t prefix_offset) {
    ...
    inline void scale_scores_inplace(float *scores, int64_t s3, int64_t s2, int64_t s1, int64_t s0, float scale) {
    ...
    inline const float *view_bshd_from_bshd_flat(const float *x,
                                                 int64_t B, int64_t S, int64_t HD,
                                                 int64_t H, int64_t D) {
        assert(HD == H * D);
        return view_reshape_3d_to_4d(x, B, S, HD, B, S, H, D);
    }

    inline float *view_bshd_from_bshd_flat(float *x,
                                           int64_t B, int64_t S, int64_t HD,
                                           int64_t H, int64_t D) {
        assert(HD == H * D);
        return view_reshape_3d_to_4d(x, B, S, HD, B, S, H, D);
    ...
    inline const float *view_bshd_flat_from_bshd(const float *x,
    ...
    inline float *view_bshd_flat_from_bshd(float *x,
                                           int64_t B, int64_t S, int64_t H, int64_t D,
                                           int64_t *out_hd) {
        *out_hd = H * D;
        return view_reshape_4d_to_3d(x, B, S, H, D, B, S, *out_hd);
    ...
    // (You can still call the primitives individually; this just reduces boilerplate.)
    // q: (B,H,S,D), k: (B,H,T,D), v: (B,H,T,D)
    // mask: (B,T) uint8 1=keep 0=mask, optional (pass nullptr if none)
    // prefix_offset: past length for cache (see apply_causal_mask)
    // out: (B,H,S,D)
    // temps: probs(B,H,S,T) caller must allocate
    // ============================

    inline void attention_core(const float *q, int64_t q3, int64_t q2, int64_t q1, int64_t q0,
                               const float *k, int64_t k3, int64_t k2, int64_t k1, int64_t k0,
                               const float *v, int64_t v3, int64_t v2, int64_t v1, int64_t v0,
                               const uint8_t *attn_mask_bt, int64_t m1, int64_t m0,
                               int64_t prefix_offset,
                               float *scores, int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                               float *probs, int64_t p3, int64_t p2, int64_t p1, int64_t p0,
                               float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        // 1) scores = q @ k^T
        const float scale = 1.0f / std::sqrt(static_cast<float>(q0));
        attn_qk_matmul(q, q3, q2, q1, q0, k, k3, k2, k1, k0, scale, scores, s3, s2, s1, s0);
    ...
    inline void slice_lastdim_4d(const float *x, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                                 int64_t start, int64_t len,
                                 float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void slice_lastdim_5d(const float *x, int64_t x4, int64_t x3, int64_t x2, int64_t x1, int64_t x0,
                                 int64_t start, int64_t len,
                                 float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void concat_lastdim_3d(const float *a, int64_t a2, int64_t a1, int64_t a0,
                                  const float *b, int64_t b2, int64_t b1, int64_t b0,
                                  float *out, int64_t o2, int64_t o1, int64_t o0) {
        assert(a2 == b2 && a1 == b1);
        assert(o2 == a2 && o1 == a1);
    ...
    inline void concat_lastdim_4d(const float *a, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                                  const float *b, int64_t b3, int64_t b2, int64_t b1, int64_t b0,
                                  float *out, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void concat_lastdim_5d(const float *a, int64_t a4, int64_t a3, int64_t a2, int64_t a1, int64_t a0,
                                  const float *b, int64_t b4, int64_t b3, int64_t b2, int64_t b1, int64_t b0,
                                  float *out, int64_t o4, int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
    ...
    inline void split_lastdim_2d_3way(const float *x, int64_t x1, int64_t x0,
                                      int64_t a0_len, int64_t b0_len, int64_t c0_len,
                                      float *out0, int64_t o01, int64_t o00,
                                      float *out1, int64_t o11, int64_t o10,
                                      float *out2, int64_t o21, int64_t o20) {
    ...
    inline void linear_qkv_fused(const float *x, int64_t x2, int64_t x1, int64_t x0, // (B,S,In)
                                 const float *w_qkv, int64_t w1, int64_t w0, // (3*Out,In)
    ...
    inline void linear_qkv_fused_split3(const float *x, int64_t B, int64_t S, int64_t In,
                                        const float *w_qkv, int64_t w1, int64_t w0,
                                        const float *b_qkv, int64_t b0,
                                        float *tmp_qkv, int64_t t2, int64_t t1, int64_t t0, // (B,S,3*Out)
                                        float *out_q, int64_t q2, int64_t q1, int64_t q0, // (B,S,Out)
                                        float *out_k, int64_t k2, int64_t k1, int64_t k0,
                                        float *out_v, int64_t v2, int64_t v1, int64_t v0) {
        assert(B == t2 && S == t1);
        assert(B == q2 && S == q1);
        assert(B == k2 && S == k1);
        assert(B == v2 && S == v1);
    ...
    inline void cross_entropy_logits_2d_label_smoothing_mean(const float *logits, int64_t l1, int64_t l0,
                                                             const int32_t *target, int64_t t0,
                                                             int32_t ignore_index,
                                                             float smoothing,
                                                             float *out, int64_t o0) {
    ...
    inline void log_softmax_2d(const float *x, int64_t x1, int64_t x0,
                               float *out, int64_t o1, int64_t o0) {
        assert(o1 == x1 && o0 == x0);
        log_softmax_lastdim(x, x1, x0, out);
    }
    ...
    // NLL for LM with precomputed log_probs: log_probs(B,S,V), labels(B,S), shift like HF.
    // loss mean over valid tokens.
    inline void nll_loss_log_probs_3d_shifted_mean(const float *log_probs, int64_t l2, int64_t l1, int64_t l0,
                                                   const int32_t *labels, int64_t y1, int64_t y0,
                                                   int32_t ignore_index,
                                                   float *out, int64_t o0) {
        assert(y1 == l2 && y0 == l1);
    ...
    inline void mask_f32_to_u8_keep(const float *m, int64_t n, float thr, uint8_t *out, int64_t o0) {
        assert(o0 == n);
        for (int64_t i = 0; i < n; ++i) out[i] = (m[i] > thr) ? static_cast<uint8_t>(1) : static_cast<uint8_t>(0);
    }

    // Build causal mask as uint8 keep matrix (S,T): keep if j<=prefix+i
    inline void build_causal_keep_mask_2d(int64_t S, int64_t T, int64_t prefix_offset,
                                          uint8_t *out, int64_t o1, int64_t o0) {
        assert(o1 == S && o0 == T);
        for (int64_t i = 0; i < S; ++i) {
            const int64_t max_j = std::min<int64_t>(T - 1, prefix_offset + i);
            uint8_t *row = out + i * T;
            for (int64_t j = 0; j < T; ++j) row[j] = (j <= max_j) ? static_cast<uint8_t>(1) : static_cast<uint8_t>(0);
        }
    }
    ...
    inline void add_score_mask_2d(float *scores, int64_t s3, int64_t s2, int64_t s1, int64_t s0,
                                  const uint8_t *keep, int64_t k1, int64_t k0,
                                  float neg = -1e9f) {
        assert(k1 == s1 && k0 == s0);
        const int64_t B = s3, H = s2, S = s1, T = s0;
        for (int64_t b = 0; b < B; ++b) {
            for (int64_t h = 0; h < H; ++h) {
                for (int64_t i = 0; i < S; ++i) {
                    ...
                    for (int64_t j = 0; j < T; ++j) if (!km[j]) row[j] += neg;
                }
            }
        }
    }
    ...
    inline void safe_div(const float *a, int64_t n,
                         const float *b, int64_t nb,
                         float eps,
                         float *out, int64_t no) {
        assert(n == nb && n == no);
    ...
    inline void embedding_lookup_bsh(const float *embedding_table, int64_t w1, int64_t w0,
                                     const int32_t *input_ids, int64_t i1, int64_t i0,
                                     float *out, int64_t o2, int64_t o1, int64_t o0) {
        assert(o2 == i1 && o1 == i0);
        assert(o0 == w0);
    ...
    inline void transpose_bthd_to_bhtd(const float *x,
                                       int64_t x3, int64_t x2, int64_t x1, int64_t x0, // (B,T,H,D)
                                       float *out,
                                       int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        // (B,H,T,D)
        assert(o3 == x3 && o2 == x1 && o1 == x2 && o0 == x0);
    ...
    inline void repeat_kv_btkd_to_bthd(const float *x,
                                       int64_t x3, int64_t x2, int64_t x1, int64_t x0, // (B,T,KVH,D)
                                       int64_t n_rep,
                                       float *out,
                                       int64_t o3, int64_t o2, int64_t o1, int64_t o0) {
        // (B,T,H,D)
    ...
    inline void kv_cache_append_btkd(float *cache,
                                     int64_t c3, int64_t c2, int64_t c1, int64_t c0, // (B,MAXT,KVH,D)
                                     const float *new_x,
                                     int64_t n3, int64_t n2, int64_t n1, int64_t n0, // (B,S,KVH,D)
                                     int64_t t_off) {
    ...
    // ============================
    inline void apply_rotary_pos_emb_bshd(float *q,
                                          int64_t q3, int64_t q2, int64_t q1, int64_t q0,
                                          float *k,
                                          int64_t k3, int64_t k2, int64_t k1, int64_t k0,
                                          const float *cos,
                                          const float *sin,
        ...
        // cos[s,d] index = (s*D + d)
        auto q_index = [S, H, D](int64_t b, int64_t s, int64_t h, int64_t d) -> int64_t {
            return (((b * S + s) * H + h) * D + d);
        };
        auto k_index = [S, KVH, D](int64_t b, int64_t s, int64_t h, int64_t d) -> int64_t {
            return (((b * S + s) * KVH + h) * D + d);
        };
        auto cs_index = [D](int64_t s, int64_t d) -> int64_t {
            return (s * D + d);
        };
